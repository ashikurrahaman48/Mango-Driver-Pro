...
export const ChipIcon = ({ className = 'w-8 h-8' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5m0 16.5v-1.5m3.75-15H21m-18 0h1.5M12 21v-1.5m0-16.5V3" />
...
export const MangoIcon = ({ className = 'w-8 h-8' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M15.04 10a6 6 0 1 0 4.96-4.5l-8.39 8.39a6 6 0 1 0 1.41 1.41l8.39-8.39Z" />
    <path d="M7.3 14.7a6 6 0 1 0-1.41-1.41L14.27 4.96a6 6 0 1 0 1.41 1.41l-8.38 8.39Z" />
  </svg>
);

export const BangladeshFlagIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} viewBox="0 0 1000 600" xmlns="http://www.w3.org/2000/svg">
      <rect fill="#006a4e" height="600" width="1000" />
      <circle fill="#f42a41" r="200" cy="300" cx="450" />
    </svg>
);
